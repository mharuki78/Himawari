...
export const knowledge = [
 ...
 {pattern:/수선|수리|as|a\/s|불량|고장/i,answer:'제품명, 구매처, 주문번호와 문제가 생긴 부분의 사진을 비공개 수선 문의에 남겨 주세요. A/S 범위와 비용은 당사 문의입니다. 예상 기간은 상태 확인 후 안내합니다. 상담 전 제품을 임의로 발송하지 말아 주세요.',link:'/support.html'},
