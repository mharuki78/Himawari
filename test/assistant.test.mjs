...
test('guide shipping terms and unknown questions stay grounded',()=>{assert.match(supportAnswer('배송비').answer,/3,500/);assert.match(supportAnswer('내 택배 어디야').answer,/내 배송 조회/);assert.equal(supportAnswer('대통령').link,'/contact.html');});
